...
typedef struct CRGB
{
    ...
    enum  	HTMLColorCode { 
        ...
        Green =0x008000, BrightGreen =0x00FF00, GreenYellow =0xADFF2F, Honeydew =0xF0FFF0, HotPink =0xFF69B4, 
        ...
        Plaid =0xCC5533, Plum =0xDDA0DD, PowderBlue =0xB0E0E6, Purple =0x800080, BrightPurple =0xFF00FF,
